...
def render_metrics(current_data):
    ...
    with col1:
        ...
        create_metric("Current Frequency", f"{current_data['Frequency']:.3f} Hz", delta)
    with col2:
    ...
    with col6:
        ...
        delta = calculate_delta("Current I1 Angle", current_data["Current_I1_Angle"])
        create_metric(
        ...
        delta = calculate_delta("Current I2 Angle", current_data["Current_I2_Angle"])
        create_metric(
    ...
    with col7:
        ...
        delta = calculate_delta("Current I3 Angle", current_data["Current_I3_Angle"])
        create_metric(
        ...
        delta = calculate_delta("Current I4 Angle", current_data["Current_I4_Angle"])
        create_metric(
    ...
    with col8:
        ...
        delta = calculate_delta("Current I5 Angle", current_data["Current_I5_Angle"])
        create_metric(
        ...
        delta = calculate_delta("Current I6 Angle", current_data["Current_I6_Angle"])
        create_metric(
    ...
    with col9:
        ...
        delta = calculate_delta("Current I7 Angle", current_data["Current_I7_Angle"])
        create_metric(
    ...
    with col10:
        ...
        delta = calculate_delta("Current I8 Angle", current_data["Current_I8_Angle"])
        create_metric(
